...
public class BlockCrops extends BlockFlower
{
    ...
    {
        return Items.appleSeeds.itemID;
    }
    ...
    public void registerIcons(IconRegister par1IconRegister)
    {
        ...
        for (int i = 0; i < this.iconArray.length; ++i)
        {
            if (i != 7)
            {
                this.iconArray[i] = par1IconRegister.registerIcon("InfinityBound:" + this.getUnlocalizedName().substring(5) + "_stage_" + i);
            }

            if (i == 7)
            {
                this.iconArray[i] = par1IconRegister.registerIcon("InfinityBound:" + "sapling_apple");
            }
        }
    }
}