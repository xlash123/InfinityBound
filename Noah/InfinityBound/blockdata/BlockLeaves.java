...
public class BlockLeaves extends BlockLeavesBase implements IShearable
{
    ...
    public static final String[][] field_94396_b = new String[][] {{"leaves_apple_opaque"}, {"leaves_apple_opaque"}};
    ...
    public void registerIcons(IconRegister par1IconRegister)
    {
        for (int i = 0; i < field_94396_b.length; ++i)
        {
            ...
            {
                this.iconArray[i][j] = par1IconRegister.registerIcon("InfinityBound:" + field_94396_b[i][j]);
            }
        }
    }
