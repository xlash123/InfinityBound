...
public class TileEntityNetherChest extends TileEntity implements IInventory
{
    ...
    /** Contains the chest tile located adjacent to this one (if any) */
    public TileEntityNetherChest adjacentChestZPosition;
    ...
    public TileEntityNetherChest(int par1)
    {
    ...
    {
        return this.isInvNameLocalized() ? this.field_94045_s : "container.chestNether";
    }
    ...
    /**
     * Sets the custom display name to use when opening a GUI for this specific TileEntityNetherChest.
     */
    ...
    private void func_90009_a(TileEntityNetherChest par1TileEntityNetherChest, int par2)
    {
        if (par1TileEntityNetherChest.isInvalid())
        {
        ...
        else if (this.adjacentChestChecked)
        {
            ...
            {
                case 0:
                    if (this.adjacentChestZPosition != par1TileEntityNetherChest)
                    {
                        this.adjacentChestChecked = false;
                    }
                ...
                case 1:
                    if (this.adjacentChestXNeg != par1TileEntityNetherChest)
                    {
                        this.adjacentChestChecked = false;
                    }
                ...
                case 2:
                    if (this.adjacentChestZNeg != par1TileEntityNetherChest)
                    {
                        this.adjacentChestChecked = false;
                    }
                ...
                case 3:
                    if (this.adjacentChestXPos != par1TileEntityNetherChest)
                    {
                        this.adjacentChestChecked = false;
                    }
            }
    ...
    private boolean func_94044_a(int par1, int par2, int par3)
    {
        ...
        return block != null && block instanceof BlockNetherChest ? ((BlockNetherChest)block).isTrapped == this.func_98041_l() : false;
    }
    ...
    {
        if (this.getBlockType() != null && this.getBlockType() instanceof BlockNetherChest)
        {
            --this.numUsingPlayers;
            this.worldObj.addBlockEvent(this.xCoord, this.yCoord, this.zCoord, this.getBlockType().blockID, 1, this.numUsingPlayers);
            this.worldObj.notifyBlocksOfNeighborChange(this.xCoord, this.yCoord, this.zCoord, this.getBlockType().blockID);
    ...
    public int func_98041_l()
    {
        ...
        {
            if (this.worldObj == null || !(this.getBlockType() instanceof BlockNetherChest))
            {
                return 0;
            }

            this.field_94046_i = ((BlockNetherChest)this.getBlockType()).isTrapped;
        }
