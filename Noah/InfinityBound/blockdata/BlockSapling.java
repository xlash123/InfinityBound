...
import Noah.InfinityBound.worldgen.WorldGenBigTree;
import Noah.InfinityBound.worldgen.WorldGenTree;
...
public class BlockSapling extends BlockFlower
{
    ...
    public void registerIcons(IconRegister par1IconRegister)
    {
        ...
        {
            this.saplingIcon[i] = par1IconRegister.registerIcon("InfinityBound:" + this.getUnlocalizedName().substring(5) + "_" + WOOD_TYPES[i]);
        }
    }
}