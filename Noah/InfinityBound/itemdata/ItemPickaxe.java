...
public class ItemPickaxe extends ItemTool
{
    ...
    public static final Block[] blocksEffectiveAgainst = new Block[] {Block.cobblestone, Block.stoneDoubleSlab, Block.stoneSingleSlab, Block.stone, Block.sandStone, Block.cobblestoneMossy, Block.oreIron, Block.blockIron, Block.oreCoal, Block.blockGold, Block.oreGold, Block.oreDiamond, Blocks.oreBedrock, Blocks.oreTfarcenim, Blocks.blockBedrock, Blocks.blockTfarcenim , Block.blockDiamond, Block.ice, Block.netherrack, Block.oreLapis, Block.blockLapis, Block.oreRedstone, Block.oreRedstoneGlowing, Block.rail, Block.railDetector, Block.railPowered, Block.railActivator};

    public ItemPickaxe(int par1, EnumToolMaterial par2EnumToolMaterial, int par6, int par7)
    {
        super(par1, 2.0F, par2EnumToolMaterial, blocksEffectiveAgainst, par6, par7);
    }
