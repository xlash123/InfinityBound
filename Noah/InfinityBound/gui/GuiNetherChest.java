...
{
    private static final ResourceLocation netherChestGui = new ResourceLocation("textures/gui/container/generic_54.png");
    ...
    public GuiNetherChest(IInventory par1IInventory, IInventory par2IInventory)
    {
    ...
    protected void drawGuiContainerBackgroundLayer(float par1, int par2, int par3)
    {
        ...
        this.mc.getTextureManager().bindTexture(netherChestGui);
