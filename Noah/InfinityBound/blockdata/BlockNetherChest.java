...
public class BlockNetherChest extends BlockContainer
{
    ...
    protected BlockNetherChest(int par1, int par2)
    {
        super(par1, Material.wood);
        this.isTrapped = par2;
        this.setCreativeTab(InfinityBound.tabInfinityBound);
    ...
    public void onBlockPlacedBy(World par1World, int par2, int par3, int par4, EntityLivingBase par5EntityLivingBase, ItemStack par6ItemStack)
    {
        ...
        {
            ((TileEntityNetherChest)par1World.getBlockTileEntity(par2, par3, par4)).setChestGuiName(par6ItemStack.getDisplayName());
        }
    }
    ...
    {
        TileEntityNetherChest TileEntityNetherChest = (TileEntityNetherChest)par1World.getBlockTileEntity(par2, par3, par4);

        if (TileEntityNetherChest != null)
        {
            for (int j1 = 0; j1 < TileEntityNetherChest.getSizeInventory(); ++j1)
            {
                ItemStack itemstack = TileEntityNetherChest.getStackInSlot(j1);
    ...
    public boolean onBlockActivated(World par1World, int par2, int par3, int par4, EntityPlayer par5EntityPlayer, int par6, float par7, float par8, float par9)
    {
        ...
        else
        {
            ...
            if (iinventory != null)
            {
                par5EntityPlayer.openGui(InfinityBound.instance, 1, par1World, par2, par3, par4);
            }
    ...
    {
        Object object = (TileEntityNetherChest)par1World.getBlockTileEntity(par2, par3, par4);
        ...
        else
        {
            ...
            {
                object = new InventoryLargeChest("container.chestNetherDouble", (TileEntityNetherChest)par1World.getBlockTileEntity(par2 - 1, par3, par4), (IInventory)object);
            }

            if (par1World.getBlockId(par2 + 1, par3, par4) == this.blockID)
            {
                object = new InventoryLargeChest("container.chestNetherDouble", (IInventory)object, (TileEntityNetherChest)par1World.getBlockTileEntity(par2 + 1, par3, par4));
            }

            if (par1World.getBlockId(par2, par3, par4 - 1) == this.blockID)
            {
                object = new InventoryLargeChest("container.chestNetherDouble", (TileEntityNetherChest)par1World.getBlockTileEntity(par2, par3, par4 - 1), (IInventory)object);
            }

            if (par1World.getBlockId(par2, par3, par4 + 1) == this.blockID)
            {
                object = new InventoryLargeChest("container.chestNetherDouble", (IInventory)object, (TileEntityNetherChest)par1World.getBlockTileEntity(par2, par3, par4 + 1));
            }
    ...
    {
        TileEntityNetherChest TileEntityNetherChest = new TileEntityNetherChest();
        return TileEntityNetherChest;
    }
    ...
    public int isProvidingWeakPower(IBlockAccess par1IBlockAccess, int par2, int par3, int par4, int par5)
    {
        ...
        {
            int i1 = ((TileEntityNetherChest)par1IBlockAccess.getBlockTileEntity(par2, par3, par4)).numUsingPlayers;
    ...
    {
        this.blockIcon = par1IconRegister.registerIcon("nether_brick");
    }
}
